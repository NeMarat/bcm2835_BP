...
typedef enum
{
    ...
    BCM2835_REGBASE_IIC2  = 9 /*Add for BananaPro by LeMaker Team*/
} bcm2835RegisterBase;
...
typedef enum
{
    ...
    BCM2835_GPIO_PUD_DOWN    = 0b10,   ///< Enable Pull Down control (modify for BananaPro by LeMaker Team)
    BCM2835_GPIO_PUD_UP      = 0b01,    ///< Enable Pull Up control (modify for BananaPro by LeMaker Team)
    BCM2835_GPIO_PUD_MASK  = 0b11    //(add for BananaPro by LeMaker Team)
} bcm2835PUDControl;
...
typedef enum
{
    BCM2835_SPI_CLOCK_DIVIDER_65536 = 3814,       ///< 65536 = 262.144us = 3.814697260kHz
    BCM2835_SPI_CLOCK_DIVIDER_32768 = 7629,   ///< 32768 = 131.072us = 7.629394531kHz
    BCM2835_SPI_CLOCK_DIVIDER_16384 = 15258,   ///< 16384 = 65.536us = 15.25878906kHz
    BCM2835_SPI_CLOCK_DIVIDER_8192  = 30517,    ///< 8192 = 32.768us = 30.51757813kHz
    BCM2835_SPI_CLOCK_DIVIDER_4096  = 61035,    ///< 4096 = 16.384us = 61.03515625kHz
    BCM2835_SPI_CLOCK_DIVIDER_2048  = 122070,    ///< 2048 = 8.192us = 122.0703125kHz
    BCM2835_SPI_CLOCK_DIVIDER_1024  = 244140,    ///< 1024 = 4.096us = 244.140625kHz
    BCM2835_SPI_CLOCK_DIVIDER_512   = 488281,     ///< 512 = 2.048us = 488.28125kHz
    BCM2835_SPI_CLOCK_DIVIDER_256   = 976562,     ///< 256 = 1.024us = 976.5625kHz
    BCM2835_SPI_CLOCK_DIVIDER_128   = 1953125,     ///< 128 = 512ns = = 1.953125MHz
    BCM2835_SPI_CLOCK_DIVIDER_64    = 3906250,      ///< 64 = 256ns = 3.90625MHz
    BCM2835_SPI_CLOCK_DIVIDER_32    = 7812500,      ///< 32 = 128ns = 7.8125MHz
    BCM2835_SPI_CLOCK_DIVIDER_16    = 15625000,      ///< 16 = 64ns = 15.625MHz
    BCM2835_SPI_CLOCK_DIVIDER_8     =  31250000,       ///< 8 = 32ns = 31.25MHz
    BCM2835_SPI_CLOCK_DIVIDER_4     =  62500000,       ///< 4 = 16ns = 62.5MHz
    BCM2835_SPI_CLOCK_DIVIDER_2     =  125000000,       ///< 2 = 8ns = 125MHz, fastest you can get
    BCM2835_SPI_CLOCK_DIVIDER_1     = 3814,       ///< 1 = 262.144us = 3.814697260kHz, same as 0/65536
...
extern "C" {
    ...
    extern void bcm2835_spi_setClockDivider(uint32_t divider);
